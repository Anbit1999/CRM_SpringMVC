	...
	<div class="container">
		<div class="row mt-4">
			<div class="col-5 m-auto">
				<h2 class="mb-4">Cập nhật công việc</h2>
				<p class="text-danger">${ message }</p>
				<input type="hidden" value="${ project.id }">
				<form action="<%=request.getContextPath()%>/project/edit"
					method="POST">
					<div class="form-group">
						<label>Tên công việc</label> <input type="text"
							class="form-control" name="name" value="${ project.name }"/>
					</div>
					<div class="form-group">
						<label>Ngày bắt đầu</label> <input type="date"
							class="form-control" name="startDate" value="${ project.startDate }"/>
					</div>
					<div class="form-group">
						<label>Ngày kết thúc</label> <input type="date"
							class="form-control" name="endDate" value="${ project.endDate }"/>
					</div>

                    ...
                    <tbody>
                    	<c:forEach items="${ listProject }" var="project">
	                    	<tr>
	                            ...
	                            <td class="w-25">
	                                <a href='<c:url value="/project/edit?id=${ project.id }" />' class="btn btn-sm btn-info">Sửa</a>
	                                <a href="<c:url value="/project/delete?id=${ project.id }" />" class="btn btn-sm btn-danger">Xóa</a>
	                            </td>
	                        </tr>
                        </c:forEach>
                    </tbody>

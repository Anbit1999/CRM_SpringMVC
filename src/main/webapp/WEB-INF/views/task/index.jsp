                    ...
                    <tbody>
                    	<c:forEach items="${ listTask }" var="task">
	                    	<tr>
	                            ...
	                            <td>${ task.endDate }</td>
	                            <td>${ task.statusDto.name }</td>
	                            <td>${ task.userDto.fullname }</td>
	                            <td>${ task.projectDto.name }</td>
	                            
	                            <td class="w-25">
	                                <a href='<c:url value="/task/edit?id=${ task.id }" />' class="btn btn-sm btn-info">Sửa</a>
	                                <a href="<c:url value="/task/delete?id=${ task.id }" />" class="btn btn-sm btn-danger">Xóa</a>
	                            </td>
	                        </tr>
                        </c:forEach>
                    </tbody>

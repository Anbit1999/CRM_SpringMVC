            ...
            <div class="col-12 mt-4">
                <div class="row">
                    ...
                    <div class="col-4 d-flex align-items-center justify-content-end">
                        <a href="<%= request.getContextPath() %>/status/add" class="btn btn-primary">Thêm mới</a>
                    </div>
                </div>
                    ...
                    <tbody>
                    	<c:forEach items="${ listStatus }" var="status">
	                    	<tr>
	                            ...
	                            <td>${ status.name }</td>
	                            <td class="w-25">
	                                <a href='<c:url value="/status/edit?id=${ status.id }" />' class="btn btn-sm btn-info">Sửa</a>
	                                <a href="<c:url value="/status/delete?id=${ status.id }" />" class="btn btn-sm btn-danger">Xóa</a>
	                            </td>
	                        </tr>
                        </c:forEach>
                    </tbody>
